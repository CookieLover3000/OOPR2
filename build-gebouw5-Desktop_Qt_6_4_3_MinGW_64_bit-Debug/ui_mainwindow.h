...
public:
    ...
    QPushButton *maakIdKnop;
    QLineEdit *lineEditUniekId;
    QLineEdit *lineEditNaam;
    QLineEdit *lineEditAdres;
    QPushButton *deleteID;
    QLineEdit *lineEditDeleteId;
    QPushButton *koppelId;
    QPushButton *ontkoppelId;
    QLineEdit *lineEditKoppelId;
    QMenuBar *menuBar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        maakIdKnop = new QPushButton(centralWidget);
        maakIdKnop->setObjectName("maakIdKnop");
        maakIdKnop->setGeometry(QRect(550, 480, 31, 31));
        lineEditUniekId = new QLineEdit(centralWidget);
        lineEditUniekId->setObjectName("lineEditUniekId");
        lineEditUniekId->setGeometry(QRect(550, 520, 113, 24));
        lineEditNaam = new QLineEdit(centralWidget);
        lineEditNaam->setObjectName("lineEditNaam");
        lineEditNaam->setGeometry(QRect(550, 550, 113, 24));
        lineEditAdres = new QLineEdit(centralWidget);
        lineEditAdres->setObjectName("lineEditAdres");
        lineEditAdres->setGeometry(QRect(550, 580, 113, 24));
        deleteID = new QPushButton(centralWidget);
        deleteID->setObjectName("deleteID");
        deleteID->setGeometry(QRect(550, 610, 31, 31));
        lineEditDeleteId = new QLineEdit(centralWidget);
        lineEditDeleteId->setObjectName("lineEditDeleteId");
        lineEditDeleteId->setGeometry(QRect(550, 650, 113, 24));
        koppelId = new QPushButton(centralWidget);
        koppelId->setObjectName("koppelId");
        koppelId->setGeometry(QRect(580, 250, 31, 31));
        ontkoppelId = new QPushButton(centralWidget);
        ontkoppelId->setObjectName("ontkoppelId");
        ontkoppelId->setGeometry(QRect(630, 250, 31, 31));
        lineEditKoppelId = new QLineEdit(centralWidget);
        lineEditKoppelId->setObjectName("lineEditKoppelId");
        lineEditKoppelId->setGeometry(QRect(550, 300, 113, 24));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        maakIdKnop->setText(QCoreApplication::translate("MainWindow", "ID", nullptr));
        deleteID->setText(QCoreApplication::translate("MainWindow", "DEL", nullptr));
        koppelId->setText(QCoreApplication::translate("MainWindow", "+", nullptr));
        ontkoppelId->setText(QCoreApplication::translate("MainWindow", "-", nullptr));
    } // retranslateUi
